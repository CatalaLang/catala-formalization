...
(** A datatype of type [list Boxer] is used to manipulate list of
  Coq values in ltac. Notation is [libtactic>> v1 v2 ... vN] for building
...
(at level 0, v1 at level 0, v2 at level 0, v3 at level 0,
 ...
 v8 at level 0)
: ltac_scope.
Notation "'libtactic>>' v1 v2 v3 v4 v5 v6 v7 v8 v9" :=
((boxer v1)::(boxer v2)::(boxer v3)::(boxer v4)::(boxer v5)
...
: ltac_scope.
Notation "'libtactic>>' v1 v2 v3 v4 v5 v6 v7 v8 v9 v10" :=
((boxer v1)::(boxer v2)::(boxer v3)::(boxer v4)::(boxer v5)
...
: ltac_scope.
Notation "'libtactic>>' v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11" :=
((boxer v1)::(boxer v2)::(boxer v3)::(boxer v4)::(boxer v5)
...
: ltac_scope.
Notation "'libtactic>>' v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12" :=
((boxer v1)::(boxer v2)::(boxer v3)::(boxer v4)::(boxer v5)
 ::(boxer v6)::(boxer v7)::(boxer v8)::(boxer v9)::(boxer v10)
...
(at level 0, v1 at level 0, v2 at level 0, v3 at level 0,
 ...
 v12 at level 0)
: ltac_scope.
Notation "'libtactic>>' v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13" :=
((boxer v1)::(boxer v2)::(boxer v3)::(boxer v4)::(boxer v5)
 ::(boxer v6)::(boxer v7)::(boxer v8)::(boxer v9)::(boxer v10)
...
(** In a list of arguments [libtactic>> H1 H2 .. HN] passed to a tactic
...
(** [lets H: (libtactic>> E0 E1 .. EN)] will instantiate lemma [E0]
...
constr(A1) :=
lets: (libtactic>> E0 A1).
Tactic Notation "lets" ":" constr(E0)
constr(A1) constr(A2) :=
lets: (libtactic>> E0 A1 A2).
Tactic Notation "lets" ":" constr(E0)
constr(A1) constr(A2) constr(A3) :=
lets: (libtactic>> E0 A1 A2 A3).
Tactic Notation "lets" ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) :=
lets: (libtactic>> E0 A1 A2 A3 A4).
Tactic Notation "lets" ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) constr(A5) :=
lets: (libtactic>> E0 A1 A2 A3 A4 A5).
...
constr(A1) :=
lets I: (libtactic>> E0 A1).
Tactic Notation "lets" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) :=
lets I: (libtactic>> E0 A1 A2).
Tactic Notation "lets" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) constr(A3) :=
lets I: (libtactic>> E0 A1 A2 A3).
Tactic Notation "lets" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) :=
lets I: (libtactic>> E0 A1 A2 A3 A4).
Tactic Notation "lets" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) constr(A5) :=
lets I: (libtactic>> E0 A1 A2 A3 A4 A5).
...
(** [forwards H: (libtactic>> E0 E1 .. EN)] is short for
  [forwards H: (libtactic>> E0 E1 .. EN ___)].
...
constr(A1) :=
forwards: (libtactic>> E0 A1).
Tactic Notation "forwards" ":" constr(E0)
constr(A1) constr(A2) :=
forwards: (libtactic>> E0 A1 A2).
Tactic Notation "forwards" ":" constr(E0)
constr(A1) constr(A2) constr(A3) :=
forwards: (libtactic>> E0 A1 A2 A3).
Tactic Notation "forwards" ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) :=
forwards: (libtactic>> E0 A1 A2 A3 A4).
Tactic Notation "forwards" ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) constr(A5) :=
forwards: (libtactic>> E0 A1 A2 A3 A4 A5).
...
constr(A1) :=
forwards I: (libtactic>> E0 A1).
Tactic Notation "forwards" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) :=
forwards I: (libtactic>> E0 A1 A2).
Tactic Notation "forwards" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) constr(A3) :=
forwards I: (libtactic>> E0 A1 A2 A3).
Tactic Notation "forwards" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) :=
forwards I: (libtactic>> E0 A1 A2 A3 A4).
Tactic Notation "forwards" simple_intropattern(I) ":" constr(E0)
constr(A1) constr(A2) constr(A3) constr(A4) constr(A5) :=
forwards I: (libtactic>> E0 A1 A2 A3 A4 A5).
...
(** [applys (libtactic>> E0 E1 .. EN)] instantiates lemma [E0]
  on the arguments [Ei] (which may be wildcards [__]),
...
(** [false E] tries to exploit lemma [E] to prove the goal false.
  [false E1 .. EN] is equivalent to [false (libtactic>> E1 .. EN)],
  which tries to apply [applys (libtactic>> E1 .. EN)] and if it
  does not work then tries [forwards H: (libtactic>> E1 .. EN)]
  followed with [false] *)
...
(* ================================================================= *)
(** ** Introduction using [=>] and [=libtactic>>] *)
...
(* [=libtactic>>] first introduces all non-dependent variables,
...
Tactic Notation "=libtactic>>" :=
intro_nondeps tt.
Tactic Notation "=libtactic>>" simple_intropattern(I1) :=
=libtactic>>; intros I1.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2) :=
=libtactic>>; intros I1 I2.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) :=
=libtactic>>; intros I1 I2 I3.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) simple_intropattern(I4) :=
=libtactic>>; intros I1 I2 I3 I4.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) simple_intropattern(I4) simple_intropattern(I5) :=
=libtactic>>; intros I1 I2 I3 I4 I5.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) simple_intropattern(I4) simple_intropattern(I5)
simple_intropattern(I6) :=
=libtactic>>; intros I1 I2 I3 I4 I5 I6.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) simple_intropattern(I4) simple_intropattern(I5)
simple_intropattern(I6) simple_intropattern(I7) :=
=libtactic>>; intros I1 I2 I3 I4 I5 I6 I7.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) simple_intropattern(I4) simple_intropattern(I5)
simple_intropattern(I6) simple_intropattern(I7) simple_intropattern(I8) :=
=libtactic>>; intros I1 I2 I3 I4 I5 I6 I7 I8.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) simple_intropattern(I4) simple_intropattern(I5)
simple_intropattern(I6) simple_intropattern(I7) simple_intropattern(I8)
simple_intropattern(I9) :=
=libtactic>>; intros I1 I2 I3 I4 I5 I6 I7 I8 I9.
Tactic Notation "=libtactic>>" simple_intropattern(I1) simple_intropattern(I2)
simple_intropattern(I3) simple_intropattern(I4) simple_intropattern(I5)
simple_intropattern(I6) simple_intropattern(I7) simple_intropattern(I8)
simple_intropattern(I9) simple_intropattern(I10) :=
=libtactic>>; intros I1 I2 I3 I4 I5 I6 I7 I8 I9 I10.
...
(** [rewrites E] is similar to [rewrite] except that
  ...
  [rewrites (libtactic>> E1 E2 E3)] to indicate that [forwards] should be
