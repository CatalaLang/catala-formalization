...
Proof.
  ...
  { simpl. eauto. }
  { erewrite if_value_value; is_value. }
Qed.
...
Proof.
  intros. intro x. asimpl. erewrite if_value_value; is_value.
Qed.
...
Lemma values_are_preserved_by_value_substitutions:
  ...
  is_value v.[sigma].
Proof.
  induction v; simpl; intros; eauto with is_value.
Qed.
